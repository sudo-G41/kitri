...
1. 면접에서
> * 면접관은 자소서 내용을 다 읽는건 아니다 핵심 문구를 읽는다. 그러니 자신의 강점을 모든곳에 녹여넣어라 물론 다르게 풀어서 적어야 한다. 단 면접관이 너무 마음에 다라 갈 수 있기 때문에 운이 좀 따를 수 있다.
> * 다시 질문해주실 수 있겠습니까?
> * 기초지식역량
> * 강점에는 무엇을 써야 하나? 해결능력?
> > 내가 잘 하는 일 대신 회사에 도움이 뒨다. Ex)IT전공이지만 그림 잘그립니다 프론트에서 디자인 잘 할 수 있습니다. | IT 지만 친화력이 넘쳐나서 화사의 단합을 제가 책임 질 수 있습니다.
> * 독해력
> > 공문, 문서 등 사람과의 대화에서 중요한 점이다.
1. 비전, 미션, 목표
> * 비>미>목
<table>
	<tr>
		<td rowspan="2">미션</td>
		<td>내가 세상에 존재하는 목적은 무엇인가</td>
		<td>									</td>
	<tr>
	<tr>
		<td>내가 세상에 기여하고 싶은 것은 무엇이며,세상에 기여할 수 있는 방법은 무엇인가.</td>
		<td></td>
	<tr>
	<tr>
		<td rowspan="2">비전</td>
		<td>내가 장기적으로 이루고 싶은 목표는 무엇인가.(예시 7년 뒤)</td>
		<td></td>
	<tr>
	<tr>
		<td>7년뒤 내가어떤 모습이었으면 좋겠는가?</td>
		<td></td>
	<tr>
	<tr>
		<td rowspan="2">핵심가치</td>
		<td>내가 가장 소중희 여기는 믿음과 신념은 무엇인가</td>
		<td></td>
	<tr>
	<tr>
		<td>내 모든 판단과 의사결정, 행동들은 어떤것을 목적을 가지고 하는가</td>
		<td></td>
	<tr>
</table>
...
1. 자소서
> * 각 파트별 키워드 필요하다.
> * 자기소개 스피치에 나의 강점, 포부, 가치 넣고해야 한다.
> * 경험을 적을때 [상황> 문제 해결을 위해 내가 한 구체적인 작업(제안) > 그래서 내가 그런 능력이 있다.]
> * 글자수는 맞춰라 고지했고 너무 불성실해 보이지 아니하게
> * 단점은 고쳐가고 있습니다를 적어라?
1. 자기소개서의 작성흐름
> * 역량
> > 내가 가진 능력
